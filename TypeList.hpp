	...
	#if defined(pankey_Log) && (defined(TypeList_Log) || defined(pankey_Global_Log) || defined(pankey_MemoryManager_Log))
		...
		class TypeList : public MemberArrayCollection<H,A>{
			public:
				...
				virtual long getType()const{
                    ...
                    TypeListLog(pankey_Log_Statement, "getType", ClassCount<P>::get());
