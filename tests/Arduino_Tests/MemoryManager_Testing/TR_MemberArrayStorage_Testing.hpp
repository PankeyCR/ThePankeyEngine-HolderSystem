	...
	namespace pankey{
		...
		namespace HolderSystem{
			...
			Base::TestResult TR_MemberArrayStorage_Testing_4(){
				...
				result.assertEqual("value should be the same", i_var_0.getValue(), i_var_01.getValue());
				result.assertEqual("value should be the same", i_var_1.getValue(), i_var_10.getValue());
			...
			Base::TestResult TR_MemberArrayStorage_Testing_19(){
				...
				result.assertEqual("storage index should be 3", i_index, 3);
			...
			void TR_MemberArrayStorage_Testing(Base::TestRunner& a_test_runner){
				...
				a_test_runner.add("MemberArrayStorage expand size", TR_MemberArrayStorage_Testing_2);
				a_test_runner.add("MemberArrayStorage set numbers", TR_MemberArrayStorage_Testing_3);
				a_test_runner.add("MemberArrayStorage replace get", TR_MemberArrayStorage_Testing_4);
				a_test_runner.add("MemberArrayStorage setExpansionRate add", TR_MemberArrayStorage_Testing_5);
				a_test_runner.add("MemberArrayStorage add contain", TR_MemberArrayStorage_Testing_6);
				a_test_runner.add("MemberArrayStorage add getIndex", TR_MemberArrayStorage_Testing_7);
				a_test_runner.add("MemberArrayStorage add getRawPointer", TR_MemberArrayStorage_Testing_8);
				a_test_runner.add("MemberArrayStorage add getHolder", TR_MemberArrayStorage_Testing_9);
				a_test_runner.add("MemberArrayStorage add removeByPointer get", TR_MemberArrayStorage_Testing_10);
				a_test_runner.add("MemberArrayStorage add removeFirstIndex", TR_MemberArrayStorage_Testing_11);
				a_test_runner.add("MemberArrayStorage add removeLastIndex", TR_MemberArrayStorage_Testing_12);
				a_test_runner.add("MemberArrayStorage add removePart", TR_MemberArrayStorage_Testing_13);
				a_test_runner.add("MemberArrayStorage add removeFirst", TR_MemberArrayStorage_Testing_14);
				a_test_runner.add("MemberArrayStorage add removeLast", TR_MemberArrayStorage_Testing_15);
				a_test_runner.add("MemberArrayStorage add clear", TR_MemberArrayStorage_Testing_16);
				a_test_runner.add("MemberArrayStorage add removePart reorder", TR_MemberArrayStorage_Testing_17);
				a_test_runner.add("MemberArrayStorage add removePart reorder with index, length and amount", TR_MemberArrayStorage_Testing_18);
				a_test_runner.add("MemberArrayStorage add removePart reorder with index, length", TR_MemberArrayStorage_Testing_19);
				a_test_runner.add("MemberArrayStorage set insert", TR_MemberArrayStorage_Testing_20);
				a_test_runner.add("MemberArrayStorage add insert set", TR_MemberArrayStorage_Testing_21);
			}
