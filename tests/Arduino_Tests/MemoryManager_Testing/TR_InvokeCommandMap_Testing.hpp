	...
	namespace pankey{
		...
		TestResult TR_InvokeCommandMap_Testing_2(){
			...
			CommandMap<CharArray,float> i_map;
...
*/
		void TR_InvokeCommandMap_Testing(TestRunner& a_test_runner){
			...
			// a_test_runner.add("CommandMap invoke with TestResult& argument", TR_InvokeCommandMap_Testing_3);
			// a_test_runner.add("CommandMap invokeAll with TestResult& argument", TR_InvokeCommandMap_Testing_4);
			// a_test_runner.add("CommandMap invoke class with TestResult& argument", TR_InvokeCommandMap_Testing_5);
			// a_test_runner.add("CommandMap invokeAll class with TestResult& argument", TR_InvokeCommandMap_Testing_6);
		}
