	...
	namespace pankey{
		...
		void TR_InvokeCommandList_Testing(TestRunner& a_test_runner){
			...
			a_test_runner.add("CommandList invoke with TestResult& argument", TR_InvokeCommandList_Testing_3);
			a_test_runner.add("CommandList invokeAll with TestResult& argument", TR_InvokeCommandList_Testing_4);
			a_test_runner.add("CommandList invoke class with TestResult& argument", TR_InvokeCommandList_Testing_5);
			a_test_runner.add("CommandList invokeAll class with TestResult& argument", TR_InvokeCommandList_Testing_6);
		}
