	...
	#if defined(pankey_Log) && (defined(ObjectArrayMap_Log) || defined(pankey_Global_Log) || defined(pankey_MemoryManager_Log))
		...
		class ObjectArrayMap : public ValueArrayMapCollection<K,V,H,M>{
			public:
				...
				virtual long getKeyBaseType()const{
                    ...
                    ObjectArrayMapLog(pankey_Log_Statement, "getKeyBaseType", ClassCount<K>::get());
				...
				virtual long getValueBaseType()const{
                    ...
                    ObjectArrayMapLog(pankey_Log_Statement, "getValueBaseType", ClassCount<V>::get());
